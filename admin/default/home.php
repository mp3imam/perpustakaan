    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-4 s-dashboard">
              <div class="panel panel-default s-dashboard">
                ...
                <div class="panel-footer">
                    <table class="table">
                        <tr>
                            <td class="text-left"><a  href="<?php echo AWB; ?>modules/bibliography/index.php"><div><i class="fa fa-square" style="color:#f2f2f2;"></i>&nbsp;&nbsp;<?php echo __('Total') ?></div></a></td>
                            <td class="text-right"><a  href="<?php echo AWB; ?>modules/bibliography/index.php"><div><?php echo $get_total?></div></a></td>
                        </tr>
                        <tr>
                            <td class="text-left"><a  href="<?php echo AWB; ?>modules/bibliography/index.php"><div><i class="fa fa-square" style="color:#337AB7;"></i>&nbsp;&nbsp;<?php echo __('New') ?></div></a></td>
                            <td class="text-right"><a  href="<?php echo AWB; ?>modules/bibliography/index.php"><div><?php echo $get_total_loan?></div></a></td>
                        </tr>
                        <tr>
                            <td class="text-left"><a  href="<?php echo AWB; ?>modules/reporting/customs/loan_history.php"><div><i class="fa fa-square" style="color:#06B1CD;"></i>&nbsp;&nbsp;<?php echo __('Return') ?></div></a></td>
                            <td class="text-right"><a  href="<?php echo AWB; ?>modules/reporting/customs/loan_history.php"><div><?php echo $get_total_return?></div></a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="text-left"><a  href="<?php echo AWB; ?>modules/reporting/customs/overdued_list.php"><div><i class="fa fa-square" style="color:#F4CC17;"></i>&nbsp;&nbsp;<?php echo __('Overdue') ?></div></a></dd>
                            <td class="text-right"><a  href="<?php echo AWB; ?>modules/reporting/customs/overdued_list.php"><div><?php echo $get_total_overdue?></div></a></td>
                        </tr>
                    </table>                                      
                </div>
              </div>
        ...
        <div class="row">
            <div class="col-xs-6 col-md-3 col-lg-3">
                <a href="<?php echo AWB; ?>modules/bibliography/index.php">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="s-widget-icon"><i class="fa fa-bookmark"></i></div>
                            <div class="s-widget-value"><?php echo $get_total_title?></div>
                            <div class="s-widget-title" style="font-size:13px;"><?php echo __('Total of Collections') ?></div>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-xs-6 col-md-3 col-lg-3">
                <a href="<?php echo AWB; ?>modules/reporting/customs/item_titles_list.php">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="s-widget-icon"><i class="fa fa-barcode"></i></div>
                            <div class="s-widget-value"><?php echo $get_total_item?></div>
                            <div class="s-widget-title" style="font-size:13px;"><?php echo __('Total of Items') ?></div>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-xs-6 col-md-2 col-lg-2">
                <a href="<?php echo AWB; ?>modules/reporting/customs/member_loan_list.php">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="s-widget-icon"><i class="fa fa-archive"></i></div>
                            <div class="s-widget-value"><?php echo $get_total_loan?></div>
                            <div class="s-widget-title" style="font-size:13px;"><?php echo __('Lent') ?></div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="<?php echo AWB; ?>modules/reporting/customs/item_titles_list.php">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="s-widget-title" style="font-size:13px;"><?php echo __('Available') ?></div>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-xs-12 col-md-2 col-lg-2">
                <a href="<?php echo AWB; ?>modules/reporting/customs/overdued_list.php">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="s-widget-icon"><i class="fa fa-clock-o"></i></div>
                            <div class="s-widget-value"><?php echo $get_total_overdue?></div>
                            <div class="s-widget-title" style="font-size:12px;"><?php echo __('Overdue'); ?></div>
                        </div>
                    </div>
                </a>
            </div>
