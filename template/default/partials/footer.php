    ...
    <div class="row">
      <div class="col-lg-6 col-sm-3 col-xs-12">
        <div class="s-footer-tagline">
          <a href="#" target=""><?php echo SENAYAN_VERSION; ?></a>
        </div>
      </div>
      <nav class="col-lg-6 col-sm-9 col-xs-12">
        <ul class="s-footer-menu">
          <li><a href="index.php"><?php echo /*__('Home')*/'ホーム'; ?></a></li>
          <li><a target="_blank" rel="archives" href="//www.jjc.or.id" title="JJC.OR.ID" class="rss" >JJC.OR.ID</a></li>
        </ul>
      </nav>
    </div>
  </div>
