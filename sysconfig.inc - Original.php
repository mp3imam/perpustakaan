...
$sysconf['mysqldump'] = 'C:\xampp\mysql\bin';
...
$sysconf['mail']['server'] = 'smtp.gmail.com';
// $sysconf['mail']['server_port'] = 465; // the SMTP port
$sysconf['mail']['server_port'] = 587;
...
// $sysconf['mail']['auth_username'] = 'oktavyapuspitadewi@gmail.com'; // SMTP account username
$sysconf['mail']['auth_username'] = 'kojinbukaijjc@gmail.com';
// $sysconf['mail']['auth_password'] = 'vyamontok'; // SMTP account password
$sysconf['mail']['auth_password'] = '3150418Jjc'; // SMTP account password
$sysconf['mail']['from'] = 'kojinbukai@jjc.or.id';
$sysconf['mail']['from_name'] = 'The Jakarta Japan Club Library Sytem';
$sysconf['mail']['reply_to'] = &$sysconf['mail']['from'];
$sysconf['mail']['reply_to_name'] = &$sysconf['mail']['from_name'];
// $sysconf['mail']['SMTPOptions'] = array(
//     'ssl' => array(
//         'verify_peer' => false,
...
if (!defined('DB_NAME')) { define('DB_NAME', '77cn3w'); }
